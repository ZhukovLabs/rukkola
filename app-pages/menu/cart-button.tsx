...
import {CART_POOL_INTERVAL, CART_QUERY_KEY} from "./config";
...
export const CartButton = () => {
    ...
    const count = useCartCount({pollInterval: CART_POOL_INTERVAL});
                ...
                <Box position="relative">
                    ...
                    <IconButton
                        ...
                        _hover={{
                            ...
                            color: "teal.100",
                            boxShadow: `0 10px 18px rgba(0,0,0,0.6), inset 0 -3px 6px rgba(255,255,255,0.08), inset 0 3px 8px rgba(255,255,255,0.08), 0 0 12px rgba(56,178,172,0.4)`,
                        }}
                        _active={{
