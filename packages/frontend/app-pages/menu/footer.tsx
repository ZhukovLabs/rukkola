        ...
        >
            ...
            <Flex justify="center" gap={4} mt={8}>
                <MotionLink
                    ...
                    {...motionProps}
                >
                    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" style={{display:"inline-block",verticalAlign:"middle"}}>
            ...
            <Box textAlign="center" mt={6} fontSize="sm" color="gray.500" borderTop="1px solid rgba(255,255,255,0.08)" pt={6}>
