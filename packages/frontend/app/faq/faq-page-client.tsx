...
const faqItems = [
    ...
    },
    {
        ...
        answer: "Да, конечно! В нашем меню представлены вегетарианские пиццы, роллы и другие закуски. Все блюда, не содержащие мяса и рыбы, отмечены специальным символом в меню."
    },
    {
    ...
    },
    {
        ...
        answer: "Да, мы предлагаем сытные завтраки и разнообразные обеденные сеты (ланчи) по будням. Приходите к нам на быстрый и вкусный перекус в центре города."
    },
    {
