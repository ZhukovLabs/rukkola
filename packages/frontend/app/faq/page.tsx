...
export const metadata: Metadata = {
    ...
    description:
        `Всё о кафе Руккола в Гомеле: актуальное меню ${CURRENT_YEAR}, цены, заказ навынос и бронь столов. Ответы на частые вопросы гостей нашего кафе на Советской 60.`,
    alternates: {
        canonical: "/faq",
    },
};
